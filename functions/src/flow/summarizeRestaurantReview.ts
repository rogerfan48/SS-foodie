    ...
    messages: (input) => {
        return [
            ...
            },
            {
                role: "user",
                content: [
                    { text: `第一段的內容請以約20-50字描述該餐廳的餐點類型。第二段請以一段約20-50字話總結提供的評論，內容需完全根據提供的顧客評論、不能自行生成，重點放在「常見的主題」、「正面」與「負面」觀點，並確保摘要清晰易懂。注意：若負面評論沒有說明原因必須忽略該評論，且該負面內容需占整體評論的40%以上才會納入考慮。輸出使用繁體中文，去除主詞，只保留描述句，先描述優點再描述缺點。不可加入主觀意見，如"推薦"或"不推薦"。以下為評論內容：\n\n${input.reviews}` }, 
                ],
            },
        ];
    },
